  ...
  return (
    <>
      ...
      <div className='fixed w-full h-full bg-gray-800 bg-opacity-50 top-0 z-40 left-0 right-0 bottom-0 flex justify-center items-center'>
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[100%] overflow-hidden'>
          ...
          <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
            ...
            <button className='px-3 py-2 bg-violet-500 text-white mb-10 hover:bg-red-700'>
              Upload Product
            </button>
          </form>
        </div>
