            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-2   my-1'>
                  <p className='text-red-600 text-3xl'>{displayINRCurrency(data.sellingPrice)}</p>
                  <p className='text-slate-400 text-sm line-through'>{displayINRCurrency(data.price)}</p>
                </div>
