            ...
            <div className='mx-auto container p-4'
                ...
                <div className='bg-white p-5 w-full max-w-sm mx-auto rounded-lg'
                    ...
                    <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit}>
                        ...
                        <button className='bg-gray-600 hover:bg-red-700 text-white px-6 py-2 w-full max-w-[150px] rounded-lg hover:scale-110 transition-all mx-auto block mt-6'>Sign Up</button>
